 ...
 * Date: 09/19/2014
 * 
 * Summary: Core utility functions, provides methods for all quantity types,
 * and initializes the library on load using reflection
 * *****************************************************************************/
...
namespace QuantityX
{
    public static class QuantityX
    {
        ...
        static QuantityX()
        {
            var assembly = typeof(QuantityX).Assembly;
